...
<template>
  ...
  <div class="wrapper">
    ...
    <div class="business-list">
      <RouterLink v-for="business in businesses" :key="business.goodsId" :to="`/business-info/${business.goodsId}`"
                  class="block w-full">
        <div class="business">
          <img :alt="business.businessName" :src="business.goodsCoverImg"/>
          <div class="business-info">
            <div class="business-name">
              <h3>{{ business.goodsName }}</h3>
            ...
            <div class="business-delivery">
              <p>平台秒杀价：{{ business.originalPrice }}元</p>
              <p>1km</p>
            </div>
