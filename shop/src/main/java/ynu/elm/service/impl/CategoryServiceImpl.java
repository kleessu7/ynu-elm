...
import ynu.elm.common.CategoryLevelEnum;
...
import ynu.elm.controller.vo.SecondLevelCategoryVO;
import ynu.elm.dao.GoodsCategoryMapper;
import ynu.elm.entity.GoodsCategory;
    ...
    public List<IndexCategoryVO> getCategoriesForIndex() {
        ...
        if (!CollectionUtils.isEmpty(firstLevelCategories)) {
            ...
            if (!CollectionUtils.isEmpty(secondLevelCategories)) {
                ...
                //处理一级分类
                if (!CollectionUtils.isEmpty(secondLevelCategoryIds)) {
                    ...
                    for (GoodsCategory firstCategory : firstLevelCategories) {
                        ...
                        if (secondLevelCategoryVOMap.containsKey(firstCategory.getCategoryId())) {
                            ...
                            indexCategoryVO.setSecondLevelCategoryVOS((BeanUtil.copyList(tempGoodsCategories, SecondLevelCategoryVO.class)));
